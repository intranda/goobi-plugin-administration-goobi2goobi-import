...
import de.intranda.goobi.plugins.rules.MetadataConfigurationItem.MetadataConfigurationType;
...
public class ImportConfiguration {
    ...
    public static List<Rule> getConfiguredItems() {
        List<Rule> answer = new ArrayList<>();
        //        Map<String, List<StepConfigurationItem>> answer = new HashMap<>();

        XMLConfiguration config = ConfigPlugins.getPluginConfig("goobi-plugin-import-database-information");
